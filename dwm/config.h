...
static const char *fonts[]          = { "Iosevka NFP Medium:size=11" };
static const char dmenufont[]       = "Iosevka NFP Medium:size=11";
...
/* tagging */
static const char *tags[] = { "", "󰄻", "", "󱞋", "", "", "", "", "󰹣" };
static const char *tagsalt[] = { "󰲠", "󰲢", "󰲤", "󰲦", "󰲨", "󰲪", "󰲬", "󰲮", "󰲰" };
